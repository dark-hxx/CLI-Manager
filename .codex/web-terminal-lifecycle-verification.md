...
- Runtime commit19153911; bundle/resource correction commit0b1c1b68. Both committed before their respective build/bundle steps. No remote push.
- Full build and corrected `tauri bundle --config src-tauri/tauri.local.conf.json --bundles nsis` exited0. Actual generated installer includes utils.nsh at20, hooks.nsh at28, Install Section608; hook macro overrides therefore precede usage. All three helpers and latest Web index-8hEFf4S7.js included. Each ConPTY DLL/EXE now has a unique architecture destination.
- Package: CLI-Manager_1.3.9_terminal-lifecycle_0b1c1b68_x64-setup.exe; 25,934,326 bytes; generated2026-09-10 16:32:36 Asia/Shanghai. Main executable file/product version1.3.9.
- SHA256: 113217CB152707374BFBD1C6E709CF9092A000FEE96093581C1D514317A63058. Root copy matches original bundle hash. Old package not removed or overwritten.
- Install: save terminal work, run new installer and choose Add/Reinstall for same-version update; refresh browser after installation. New maximum batch setting is in Web device connection settings, default96KiB; larger options256/512KiB. Do not switch to large batches as a substitute for adequate bandwidth.
