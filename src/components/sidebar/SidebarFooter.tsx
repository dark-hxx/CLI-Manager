...
export function SidebarFooter({
  ...
  return (
    <div className="px-3 py-2">
      ...
      <div className="mt-3 flex items-center justify-between rounded-xl border border-border bg-surface-container-low px-3 py-2.5 shadow-[0_0_0_1px_color-mix(in_srgb,var(--primary)_14%,transparent)]">
      ...
      <div className="mt-2 flex items-start justify-between gap-3 rounded-xl border border-border bg-surface-container-low px-3 py-2.5 shadow-[0_0_0_1px_color-mix(in_srgb,var(--primary)_14%,transparent)]">
        <div>
