...
import { useSidebarWebDeviceActions } from "./useSidebarWebDeviceActions";
...
export function useSidebarController({
  ...
  useSidebarWebDeviceActions({
    confirm, t, projects, worktrees, groups, selectedId, setSelectedId, setSelectedProjectIds,
    closeSession, deleteProject, removeSyncedSessions, deleteGroup, ensureSidebarExpanded,
    setEditingProject, setRenamingProjectId, setProviderSwitchTarget, setNewGroupParentId,
    setBatchShellPreselected, setFinishTarget, handleOpenProjectDirectory, handleOpenProjectFiles,
    handleOpenProjectHistory, handleCloneProject, handleAddProjectToGroup, handleStopGroup,
    handleSelectGroupScope, handleRenameGroup, handleOpenWorktreeDirectory,
