...
!macro CLI_MANAGER_STOP_INSTALLED_PROCESSES
  ...
  nsExec::ExecToLog /TIMEOUT=30000 '"$SYSDIR\WindowsPowerShell\v1.0\powershell.exe" -NoLogo -NoProfile -NonInteractive -ExecutionPolicy Bypass -File "$PLUGINSDIR\cli-manager-cleanup.ps1" -InstallDirectory "$INSTDIR"'
  Pop $0
  ${If} $0 != 0
