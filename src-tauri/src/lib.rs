...
const MIGRATION_ADD_GROUP_BOUND_PATH_VERSION: i64 = 35;
const MIGRATION_ADD_GROUP_BOUND_PATH_DESCRIPTION: &str = "add_bound_path_to_groups";
const MIGRATION_ADD_GROUP_BOUND_PATH_SQL: &str =
    "ALTER TABLE groups ADD COLUMN bound_path TEXT NOT NULL DEFAULT '';";
const MIGRATION_ADD_PROJECT_PATH_MODE_VERSION: i64 = 36;
const MIGRATION_ADD_PROJECT_PATH_MODE_DESCRIPTION: &str = "add_project_path_mode";
const MIGRATION_ADD_PROJECT_PATH_MODE_SQL: &str =
...
mod provider_migration_tests {
    ...
    use crate::{
        ...
        MIGRATION_ADD_PROJECT_PATH_MODE_VERSION, MIGRATION_ADD_USAGE_ERROR_DETAIL_VERSION,
    ...
    fn history_generated_titles_and_request_project_path_migrations_are_additive() {
        ...
        assert!(registry
            .iter()
            .all(|migration| migration.version <= project_path_mode_migration.version));
