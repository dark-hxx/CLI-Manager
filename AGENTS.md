...
This project is indexed by GitNexus as **CLI-Manager** (14083 symbols, 26877 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
