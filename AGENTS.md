...
This project is indexed by GitNexus as **CLI-Manager** (19147 symbols, 37967 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
