...
This project is indexed by GitNexus as **CLI-Manager** (18319 symbols, 37502 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
