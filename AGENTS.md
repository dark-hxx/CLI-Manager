...
This project is indexed by GitNexus as **CLI-Manager** (12216 symbols, 23261 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
