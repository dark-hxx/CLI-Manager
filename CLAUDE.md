...
This project is indexed by GitNexus as **CLI-Manager** (26944 symbols, 54696 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
